              ...
              <div class="row">
                <div class="col-lg-5 col-md-6">
                  <div class="slider_detail-box">
                    ...
                    <p>
                      Simply the best way to keep watch on your favourite Stocks
                    </p>
                    <div class="btn-box">
                      <a href="#why_choose_us" class="btn-1">
                        Read More
                      </a>
                    </div>
                  </div>
...
-->
        ...
        <div class="service_box">
          ...
          <div class="detail-box">
            ...
            <p>
              Stock Name,Price, High and Low Price of Stock will be shown we can add stock to our wishlist.
            </p>
          </div>
        </div>
        <div class="service_box">
